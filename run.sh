...
show_banner() {
    ...
    echo -e "\e[0m"
    echo -e "\e[1;34m  ---------------------------------------------------------- \e[0m"
    echo -e "\e[1;32m             Powered BY SDGAMER (V 26.1)              \e[0m"
    echo -e "\e[1;34m  ---------------------------------------------------------- \e[0m"
}
...
while true; do
    ...
    case $choice in
        ...
        8)  bash <(curl -fsSL https://raw.githubusercontent.com/nobita329/The-Coding-Hub/main/srv/External/1panel.sh) ; pause_and_return ;;
